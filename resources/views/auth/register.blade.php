...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jun 2017 12:33:15 GMT -->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/bootstrap.icon.css" />
</head>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <form class="form" method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="optionsCheckboxes" checked> I agree
                                                    to the
        ...
        <ul class="dropdown-menu">
            ...
            <li class="button-container">
                ...
                <button id="facebook" class="btn btn-social btn-facebook btn-round"><i
                        class="fa fa-facebook-square"></i> &middot; 50</button>
            </li>
        </ul>
    </div>
</div>
...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jun 2017 12:33:55 GMT -->
